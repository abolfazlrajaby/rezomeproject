...
<div class="page-content">
    <div>
                ...
                <div class="page-header page-header-small" filter-color="green">
                    ...
                    <div class="container">
                        <div class="content-center">
                            <div class="cc-profile-image"><a href="#"><img src="images/b.jpg" alt="Image"/></a>
                            </div>
                            <div class="h2 title">Abolfazl Rajaby</div>
                            <p class="category text-white">Web Developer, Graphic Designer</p><a
                                class="btn btn-primary smooth-scroll mr-2" href="#login" data-aos="zoom-in"
                                data-aos-anchor="data-aos-anchor">LOGIN</a>
                        </div>
                    </div>
                    <div class="section">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <p>Hello! I am Abolfazl Rajaby. computer engineering Web Developer, Graphic Designer</p>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-8">abolfazlrajabyebgha@gmail.com</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
                                    <div class="col-sm-8">+989362310325</div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Job:</strong></div>
                                    <div class="col-sm-8">computer engineering</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section" id="login">
            <div class="cc-contact-information" style="background-image: url('images/a.png');">
                <div class="container">
                    <div class="cc-contact">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="card mb-0" data-aos="zoom-in">
                                    <div class="h4 text-center title">LOGIN</div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-body">
